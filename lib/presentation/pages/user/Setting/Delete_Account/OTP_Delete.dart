...
import 'package:coolappflutter/presentation/pages/user/Setting/Delete_Account/After_Delete_Account.dart';
...
class OtpDelete extends StatefulWidget {
  const OtpDelete({super.key});

  @override
  State<OtpDelete> createState() => _OtpDeleteState();
}

class _OtpDeleteState extends State<OtpDelete> {
