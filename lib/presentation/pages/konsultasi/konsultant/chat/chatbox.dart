...
class ChatPageByConsultant extends StatefulWidget {
  final bool status;

  ChatPageByConsultant({required this.status});

  @override
  _ChatPageByConsultantState createState() => _ChatPageByConsultantState();
}

class _ChatPageByConsultantState extends State<ChatPageByConsultant> {
