...
class HisotryCurhat extends StatefulWidget {
  const HisotryCurhat({super.key});

  @override
  State<HisotryCurhat> createState() => _HisotryCurhatState();
}

class _HisotryCurhatState extends State<HisotryCurhat> {
  ...
  final List<Widget> _tabs = [
    TabHistorySession(type: "curhat",),
    TabHistoryRequest(type: "curhat",),
    TabHisotryWaiting(type: "curhat",),
    TabHistoryArsip(type: "curhat",),
  ];
