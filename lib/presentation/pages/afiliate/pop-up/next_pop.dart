      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            gapH10,
            Text(S.of(context).affiliatorAccountNotice,style: TextStyle(fontSize: 15,fontWeight: FontWeight.w500),textAlign: TextAlign.center,),
            gapH20,
            Text(S.of(context).viewOldProfiling,style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400),textAlign: TextAlign.center,),
            gapH10,
            ...
            }, color: Colors.white, text: S.of(context).useAnotherAccount,textStyle: TextStyle(fontWeight: FontWeight.w500,color: primaryColor),)
          ],
        ),
      ),
    );
