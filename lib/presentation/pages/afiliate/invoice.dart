          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                gapH20,
                Text(S.of(context).affiliate_program,style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400),),
                Text(S.of(context).welcome_affiliate_program,style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400),),
                gapH20,
                Text(S.of(context).affiliate_agreement,style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400),),
                Text('1. ' + S.of(context).deposit_info,style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400),),
                Text('2. ' + S.of(context).commission_info,style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400),),
                Text('3. ' + S.of(context).rights_responsibilities,style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400),),
                Text('4. ' + S.of(context).cancellation_changes,style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400),),
