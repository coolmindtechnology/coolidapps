...
class ChatCurhatArchive extends StatefulWidget {
  const ChatCurhatArchive({super.key});

  @override
  _ChatCurhatArchiveState createState() => _ChatCurhatArchiveState();
}

class _ChatCurhatArchiveState extends State<ChatCurhatArchive> {
