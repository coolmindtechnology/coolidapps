  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: containerColor ?? BlueColor, // Warna default atau opsional
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            ...
            child: Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: textColor ??
                      BlueColor, // Warna teks default atau opsional
          ...
          Expanded(
            ...
            child: ClipRRect(
              borderRadius:
                  BorderRadius.circular(20), // Menyesuaikan sudut gambar
              child: Image.asset(
                imageUrl, // URL gambar
                fit: BoxFit.cover, // Agar gambar memenuhi ruang
                height:
                    140, // Menyesuaikan tinggi gambar dengan container/ Menyesuaikan tinggi gambar dengan container
              ),
            ),
          ),
        ],
