...
//
//     final resTransaksiEbook = resTransaksiEbookFromJson(jsonString);

import 'dart:convert';

ResTransaksiEbook resTransaksiEbookFromJson(String str) =>
    ResTransaksiEbook.fromJson(json.decode(str));

String resTransaksiEbookToJson(ResTransaksiEbook data) =>
    json.encode(data.toJson());

class ResTransaksiEbook {
  bool? success;
  dynamic message;
  DataTransaksi? data;
  ...
  factory ResTransaksiEbook.fromJson(Map<String, dynamic> json) =>
      ResTransaksiEbook(
        success: json["success"],
        message: json["message"],
        data:
            json["data"] == null ? null : DataTransaksi.fromJson(json["data"]),
      );
