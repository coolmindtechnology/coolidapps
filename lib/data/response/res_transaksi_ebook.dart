...
ResTransaksiEbook resTransaksiEbookFromJson(String str) => ResTransaksiEbook.fromJson(json.decode(str));

String resTransaksiEbookToJson(ResTransaksiEbook data) => json.encode(data.toJson());
...
class ResTransaksiEbook {
  ...
  factory ResTransaksiEbook.fromJson(Map<String, dynamic> json) => ResTransaksiEbook(
