...
ResGetUserProfiling resGetUserProfilingFromJson(String str) =>
    ResGetUserProfiling.fromJson(json.decode(str));

String resGetUserProfilingToJson(ResGetUserProfiling data) =>
...
class ResGetUserProfiling {
  ...
  factory ResGetUserProfiling.fromJson(Map<String, dynamic> json) =>
      ResGetUserProfiling(
        success: json["success"],
        message: json["message"],
        data:
            json["data"] == null ? null : UserProfiling.fromJson(json["data"]),
      );
