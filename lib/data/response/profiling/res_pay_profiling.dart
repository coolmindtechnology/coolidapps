...
ResPayProfiling resPayProfilingFromJson(String str) =>
    ResPayProfiling.fromJson(json.decode(str));

String resPayProfilingToJson(ResPayProfiling data) =>
...
class ResPayProfiling {
  ...
  factory ResPayProfiling.fromJson(Map<String, dynamic> json) =>
      ResPayProfiling(
