...
ResInvoiceRealMoney resInvoiceRealMoneyFromJson(String str) => ResInvoiceRealMoney.fromJson(json.decode(str));

String resInvoiceRealMoneyToJson(ResInvoiceRealMoney data) => json.encode(data.toJson());
...
class ResInvoiceRealMoney {
  ...
  factory ResInvoiceRealMoney.fromJson(Map<String, dynamic> json) => ResInvoiceRealMoney(
    success: json["success"],
    message: json["message"],
    data: json["data"] == null ? null : DataInvoiceRealMoney.fromJson(json["data"]),
  );
...
class DataInvoiceRealMoney {
  ...
  factory DataInvoiceRealMoney.fromJson(Map<String, dynamic> json) => DataInvoiceRealMoney(
    id: json["id"],
    idUser: json["id_user"],
    ...
    payoutsDetail: json["payouts_detail"] == null ? [] : List<dynamic>.from(json["payouts_detail"]!.map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "payouts_detail": payoutsDetail == null ? [] : List<dynamic>.from(payoutsDetail!.map((x) => x)),
    "user": user?.toJson(),
    "affiliate": affiliate,
  };
}
