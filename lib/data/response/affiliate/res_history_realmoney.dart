...
ResHistoryRealMoney resHistoryRealMoneyFromJson(String str) => ResHistoryRealMoney.fromJson(json.decode(str));

String resHistoryRealMoneyToJson(ResHistoryRealMoney data) => json.encode(data.toJson());
...
class ResHistoryRealMoney {
  ...
  factory ResHistoryRealMoney.fromJson(Map<String, dynamic> json) => ResHistoryRealMoney(
    success: json["success"],
    message: json["message"],
    data: json["data"] == null ? null : DataPaginationHistoryRealMoney.fromJson(json["data"]),
  );
...
class DataPaginationHistoryRealMoney {
  ...
  factory DataPaginationHistoryRealMoney.fromJson(Map<String, dynamic> json) => DataPaginationHistoryRealMoney(
    currentPage: json["current_page"],
    data: json["data"] == null ? [] : List<HistoryRealMoney>.from(json["data"]!.map((x) => HistoryRealMoney.fromJson(x))),
...
class HistoryRealMoney {
  ...
  factory HistoryRealMoney.fromJson(Map<String, dynamic> json) => HistoryRealMoney(
    id: json["id"],
    idUser: json["id_user"],
