...
ResInvoiceTransaction resInvoiceTransactionFromJson(String str) => ResInvoiceTransaction.fromJson(json.decode(str));

String resInvoiceTransactionToJson(ResInvoiceTransaction data) => json.encode(data.toJson());
...
class ResInvoiceTransaction {
    ...
    factory ResInvoiceTransaction.fromJson(Map<String, dynamic> json) => ResInvoiceTransaction(
        success: json["success"],
        message: json["message"],
        data: json["data"] == null ? null : DataInvoiceTransaction.fromJson(json["data"]),
    );
...
class DataInvoiceTransaction {
    ...
    factory DataInvoiceTransaction.fromJson(Map<String, dynamic> json) => DataInvoiceTransaction(
