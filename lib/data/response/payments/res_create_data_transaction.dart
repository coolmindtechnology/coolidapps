...
//
//     final resCreateDataTransaction = resCreateDataTransactionFromJson(jsonString);

import 'dart:convert';

ResCreateDataTransaction resCreateDataTransactionFromJson(String str) =>
    ResCreateDataTransaction.fromJson(json.decode(str));

String resCreateDataTransactionToJson(ResCreateDataTransaction data) =>
    json.encode(data.toJson());

class ResCreateDataTransaction {
  bool? success;
  String? message;
  DataCreateTransaction? data;

  ResCreateDataTransaction({
    this.success,
    this.message,
    this.data,
  });

  factory ResCreateDataTransaction.fromJson(Map<String, dynamic> json) =>
      ResCreateDataTransaction(
        success: json["success"],
        message: json["message"],
        data: json["data"] == null
            ? null
            : DataCreateTransaction.fromJson(json["data"]),
      );
...
class DataCreateTransaction {
  ...
  factory DataCreateTransaction.fromJson(Map<String, dynamic> json) =>
      DataCreateTransaction(
        id: json["id"],
