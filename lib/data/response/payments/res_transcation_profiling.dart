...
ResTransactionProfiling resTransactionProfilingFromJson(String str) => ResTransactionProfiling.fromJson(json.decode(str));

String resTransactionProfilingToJson(ResTransactionProfiling data) => json.encode(data.toJson());
...
class ResTransactionProfiling {
  ...
  factory ResTransactionProfiling.fromJson(Map<String, dynamic> json) => ResTransactionProfiling(
    success: json["success"],
    message: json["message"],
    data: json["data"] == null ? null : DataTransactionProfiling.fromJson(json["data"]),
  );
...
class DataTransactionProfiling {
  ...
  factory DataTransactionProfiling.fromJson(Map<String, dynamic> json) => DataTransactionProfiling(
    id: json["id"],
