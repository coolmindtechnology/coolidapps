class DataMemberAffiliate {
  ...
  factory DataMemberAffiliate.fromJson(Map<String, dynamic> json) =>
      DataMemberAffiliate(
        id: json["id"],
        idRole: json["id_role"],
        name: json["name"],
        ...
        profilings: json["profilings"] == null
            ? []
            : List<Profiling>.from(
                json["profilings"]!.map((x) => Profiling.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "profilings": profilings == null
            ? []
            : List<dynamic>.from(profilings!.map((x) => x.toJson())),
      };
}
